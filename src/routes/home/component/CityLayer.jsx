            ...
            <div className="cityLayer">
                ...
                <div className="cityLayer__content" >
                    <div className="cityBlock" id="定位">
                        ...
                        <div className="cityBlock__wrap">
                            <div className="cityBlock__item" onClick={onSelect.bind(this,"杭州")}>杭州</div>
                        </div>
                    </div>
                    <div className="cityBlock" id="热门">
                        ...
                        <div className="cityBlock__wrap">
                            {
                                hot.map(city => <div key={city.cityCode} className="cityBlock__item" onClick={onSelect.bind(this,city.regionName)}>{city.regionName}</div>)
                            }
                        </div>
                    </div>
                    {
                ...
                <div className="cityLayer__index cityIndex">
                    <ul className="cityIndex__list">
                        ...
                        {
                            alphabetKeys.map(ele => <li key={ele} className="cityIndex__item"><a href={`#${ele}`}>{ele}</a></li>)
                        }
                    </ul>
                </div>
            </div>
